...
namespace CarSys
{
    public partial class RemoveStaff : Form
    {
        ...
        {
            var confirmResult = MessageBox.Show("Are You Sure You want To Remove This Staff?", "Remove", MessageBoxButtons.YesNo);
        ...
        private void UpdateStaff()
        {
            ...
            try
            {
                ...
                String strSQL = "DELETE FROM Staff WHERE StaffID = " + StaffTxt.Text;
